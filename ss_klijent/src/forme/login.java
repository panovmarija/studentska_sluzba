...
public class login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        brpok--;
        Radnik r=new Radnik("", "", jTextField1.getText(), String.valueOf(jPasswordField1.getPassword()));
        KlijentZahtev kz=new KlijentZahtev(operacije.Operacije.login, r);
        komunikacija.Komunikacija.getInstance().posaljiZahtev(kz);
        ServerOdg so=komunikacija.Komunikacija.getInstance().primiOdg();
        r=(Radnik) so.getOdg();
        if(!r.getIme().isEmpty())
        {
            GlavnaForma gf=new GlavnaForma(null, rootPaneCheckingEnabled, r);
            gf.setVisible(true);
...
//           samo gasim soket sto ce ugasiti obradu
            komunikacija.Komunikacija.getInstance().zatvoriSoket();
            this.dispose();
            return ;
        }
            JOptionPane.showMessageDialog(this, "probaj ponovo");
        }
